...
<?php get_header(); ?>
	...
	<?php 
	$currentPostID = '';
	$my_secondary_loop = new WP_Query(array( 'orderby' => 'date', 'order' => 'DESC', 'post_type' => 'post', 'posts_per_page' => 1 )); ?>
	 ...
	 <div class="fixedContainerBox cases">
		<div class="fixedContainer">
			...
			if ( has_post_thumbnail() ) { 
				$imageURL = wp_get_attachment_url( get_post_thumbnail_id($post->ID), 'extra-large-image' ); 
